<template>
  <div class="container">
    ...
    <div id="protocol-main" class="protocol-main">
      ...
      <div class="line-item">
        a. 您不会以暴力、威胁、恐吓、骚扰、欺骗、强迫等方式侵犯他人合法权益或影响服务提供的安全性，不会随身携带或者在行李中夹带易燃、易爆、有毒、有腐蚀性、有放射性以及有可能危及运输工具上人身和财产安全的危险物品或者其他违禁物品；
        <br />b. 您不会在车内发生具有或可能具有危害人身或财产安全的行为；
        <br />c. 您不会携带具有或可能具有攻击性的宠物；如果您按照国家或地方有关规定携带导盲犬，则不受本条款约定限制；
        <br />d. 您不会发生饮酒、吸烟等可能影响他人身心健康或服务安全的行为；
        <br />e. 您不会故意损坏车内的物品、设备或污染服务环境；
        <br />f. 您不会以任何形式制造虚假用车需求以获取或帮助他人获取不当利益。
      </div>
    </div>
  </div>
</template>
